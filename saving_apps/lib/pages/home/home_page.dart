...
import 'package:saving_apps/styles/colors.dart';
import 'package:saving_apps/styles/text.style.dart';
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      _trasactionButton('assets/save.png', 'Save Money'),
                      SizedBox(
                        width: 25,
                      ),
                      _trasactionButton('assets/pay.png', 'Pay'),
                    ],
                  )
                ],
              ),
